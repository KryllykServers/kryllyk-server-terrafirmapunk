...
recipes.addShapeless(<Railcraft:part.rail:2> * 4, [<terrafirmacraft:item.Bronze Ingot>, <Railcraft:part.tie>]);

recipes.addShapeless(<Railcraft:part.rail:2> * 4, [<terrafirmacraft:item.Bismuth Bronze Ingot>, <Railcraft:part.tie>]);

recipes.addShapeless(<Railcraft:part.rail:2> * 4, [<terrafirmacraft:item.Black Bronze Ingot>, <Railcraft:part.tie>]);
